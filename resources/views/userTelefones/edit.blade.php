...
@section('conteudo')
    ...
    <form action="{{ route('userTelefones.update', $userTelefone) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
        <div class="col-4" >
        ...
        <div class="row">
            <div class="col">
                <a href="{{ route('users.show', $userTelefone->user_id) }}" class="btn btn-secondary btn-block align-content-center">
