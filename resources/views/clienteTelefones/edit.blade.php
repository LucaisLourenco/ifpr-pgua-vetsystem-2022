...
@section('conteudo')
    ...
    <form action="{{ route('clienteTelefones.update', $clienteTelefone) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
        <div class="col-4" >
        ...
        <div class="row">
            <div class="col">
                <a href="{{ route('clientes.show', $clienteTelefone->cliente_id) }}" class="btn btn-secondary btn-block align-content-center">
