@extends('templates.main', ['titulo' => "Alterar Telefone"])

@section('titulo')- Alterar Telefone @endsection

@section('conteudo')

    <form action="{{ route('veterinarioTelefones.update', $veterinarioTelefone) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
        <div class="col-4" >
                <div class="form-floating mb-3">
                    <input 
                        ...
                        value="{{$veterinarioTelefone->nome}}"
                        required
                    />
            ...
            <div class="col-4" >
                <div class="form-floating mb-3">
                    <input 
                        ...
                        value="{{$veterinarioTelefone->numero}}"
                        required
                    />
        ...
        <div class="row">
            <div class="col">
                <a href="{{ route('veterinarios.show', $veterinarioTelefone->veterinario_id) }}" class="btn btn-secondary btn-block align-content-center">
