...
@section('conteudo')
    ...
    <form action="{{ route('veterinarioTelefones.store') }}" method="POST">
        @csrf

        <input type="hidden" name="veterinario_id" value="{{ $veterinario }}"/>
        ...
        <div class="row">
            <div class="col">
                <a href="{{ route('veterinarios.show', $veterinario) }}" class="btn btn-secondary btn-block align-content-center">
