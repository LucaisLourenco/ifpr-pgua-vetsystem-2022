...
<html lang="pt-br">
    <head>
        ...
        <title> VetSystem @yield('titulo')</title>
    ...
    <body>
                ...
                <div class="collapse navbar-collapse" id="itens">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown ps-1">
                            ...
                            @if(UserPermissions::isAuthorized('consultaagendamentos.index'))
                                <li><a href="{{ route('consultaagendamentos.index') }}" class="dropdown-item">Gerenciar Consultas</a></li>
                            @endif

                            @if(UserPermissions::isAuthorized('servicoagendamentos.index'))
                        ...
                        @if(UserPermissions::isAuthorized('parametros.index'))
                            <li class="nav-item dropdown ps-1">
                                <a class="nav-link dropdown-toggle text-dark" data-bs-toggle="dropdown" href="#">
        ...
        <div class="container py-4">
            <div class="row">
                ...
                @if(isset($rota))
                    @if(UserPermissions::isAuthorized($rota))
