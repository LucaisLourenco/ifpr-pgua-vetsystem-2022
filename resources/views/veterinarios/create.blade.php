...
@section('titulo')- Cadastrar Veterinário @endsection
                ...
                <div class="form-floating mb-3">
                    ...
                    <option value="{{null}}">SELECIONE A ESPECIALIDADE</option>
                        @foreach ($especialidades as $item) 
                            <option value="{{$item->id}}"  @if($item->id == old('especialidade_id')) selected="true" @endif>
                                {{$item->nome}}
                            </option>
                        @endforeach
                    </select>
