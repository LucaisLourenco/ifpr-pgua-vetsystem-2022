...
<html lang="pt-br">
    <head>
        ...
        <title> VetSystem Cliente @yield('titulo')</title>
    ...
    <body>
                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item dropdown ps-1">
                            <a class="nav-link dropdown-toggle text-dark" data-bs-toggle="dropdown" href="#">
                                ...
                                </svg> {{ Auth::guard('cliente')->user()->name }}
                            </a>
                            <ul class="dropdown-menu">
                                <li>
                                    <form method="POST" action="{{ route('cliente.logout') }}" id="form">
                                        {{ csrf_field() }}    
        ...
        <nav class="navbar fixed-bottom navbar-dark" style="background-color: #c44d4d;">
            <div class="container-fluid">
    ...
    <script type="text/javascript">
        ...
        function showInfoModalSuccess() {
            ...
            for(let a=0; a< arguments.length; a++) {
                $('#infoModalSuccess').modal().find('.modal-body').append("<h7><strong> Hi {{Auth::guard('cliente')->user()->name}}! </strong>" + arguments[a] + "</h7>");
            }
        ...
        function showInfoModalDanger() {
            ...
            for(let a=0; a< arguments.length; a++) {
                $('#infoModalDanger').modal().find('.modal-body').append("<h7><strong> Hi {{Auth::guard('cliente')->user()->name}}! </strong>" + arguments[a] + "</h7>");
            }
